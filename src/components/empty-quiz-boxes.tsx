...
export function EmptyQuizBoxes() {
  return (
    <div className="text-center py-16">
      ...
      <Link href="/quiz-boxes/new" className="inline-block px-6 py-3 bg-[#4F7CFF] text-white font-medium rounded-xl hover:bg-[#6B91FF] transition-all duration-200 active:scale-[0.98]">
        첫 퀴즈 만들기
      </Link>
    </div>
  );
