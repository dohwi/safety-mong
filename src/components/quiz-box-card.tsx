...
export function QuizBoxCard({ box }: { box: QuizBox }) {
  return (
    <Link
      ...
      className="group relative block p-7 border border-[rgba(0,0,0,0.08)] rounded-[24px] bg-white transition-all duration-200 hover:border-[#4F7CFF]/40 hover:shadow-[0_8px_24px_rgba(0,0,0,0.04)] hover:translate-y-[-4px] active:scale-[0.98] active:translate-y-0 overflow-hidden"
    >
