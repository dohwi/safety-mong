...
export function QuizBoxCard({ box }: { box: QuizBox }) {
  return (
    <Link
      ...
      className="group relative block p-7 border border-[rgba(0,0,0,0.06)] rounded-[2.5rem] bg-white hover:border-[#4F7CFF]/30 transition-all duration-300 hover:shadow-[0_20px_48px_rgba(79,124,255,0.12)] hover:translate-y-[-8px] active:scale-[0.98] active:translate-y-0 overflow-hidden"
    >
